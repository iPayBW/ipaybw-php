 ...
 */
class Invoice extends \IPayBW\Models\Base
{
     ...
     * can be found here: http://developers.ipaybw.com/docs/miscellaneous
     *
     * @param int $psp
     */
     ...
     * This name will only be shown to administrator of the IPayBW site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.ipaybw.com/docs/miscellaneous
     *
    ...
    {
        return new \IPayBW\Models\Response\Invoice();
    }
}
