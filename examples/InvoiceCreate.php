...
$invoice = new \IPayBW\Models\Request\Invoice();
...
$invoice->setDescription('Thanks for using IPayBW to pay your order');

// administrative information, which provider to use (psp)
// psp #1 = IPayBW' test mode, see http://developers.ipaybw.com/docs/miscellaneous
$invoice->setPsp(1);
...
// http://developers.ipaybw.com/docs/miscellaneous
...
try {
    $response = $ipaybw->create($invoice);
    var_dump($response);
