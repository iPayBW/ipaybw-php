...
// optional: payment service provider(s) to use (see http://developers.ipaybw.com/docs/miscellaneous)
...
$gateway->addField($type = 'email', $value = 'max.muster@ipaybw.com');
...
try {
    $response = $ipaybw->create($gateway);
    var_dump($response);
